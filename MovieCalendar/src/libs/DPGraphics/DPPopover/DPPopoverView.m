...
#define DP_POPOVER_ARROW_HEIGHT 5.0
#define DP_POPOVER_ARROW_BASE 10.0
#define DP_POPOVER_RADIUS 3.0

- (id) initWithFrame: (CGRect) frame style: (DPPopoverStyle) aStyle {

    self = [super initWithFrame: frame];
    if (self) {
        style = (DPPopoverStyle *) aStyle;
        ...
        self.innerShadow = [[UIView alloc] init];
